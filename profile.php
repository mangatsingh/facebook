...
if(isset($_POST['post_message'])) {
 ...
 ?>
    ...
    <h4 style="font-size: 30px; margin: 0px 0px 10px 0px;"><?php echo $user_array['first_name'] . " " . $user_array['last_name']; ?></h4>
 		<div class="profile_info">
 			<p><?php echo "Posts: " . $user_array['num_posts']; ?></p>
 			<p><?php echo "Likes: " . $user_array['num_likes']; ?></p>
 			<p><?php echo "Friends: " . $num_friends ?></p>
      <p><a href="friends.php?username=<?php echo $username; ?>" style="font-size: 15px;font-weight: bold;color: #0043f0;">View friends</a></p>
 		</div>
    ...
    <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane" id="messages_div">
        <?php  
          ...
          echo "<h4>You and <a href='" . $username ."' style='color:#2900ff;'>" . $profile_user_obj->getFirstAndLastName() . "</a></h4>";
