...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/priblo/assets/images/profile_pics';
	//Set File name	
...
***********************************************************/		
		...
		// Specify The new size
			$main_width = 300; // set the width of the image
...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:100%; max-height:60000px; background-color:#FFF; position:relative; overflow:scroll; border:none; z-index:2001; padding-bottom:0px;">  
	    
	        <div id="CroppingArea" style="width:100%; max-height:40000px; position:relative; overflow:scroll; margin:0px auto; border:1px #666 solid; float:left;">	
	            <img src="<?=$imgSrc?>" border="0" id="jcrop_target" style="border:0px #990000 solid; position:relative; margin:0px 0px 0px 0px; padding:0px; width:100%; max-height:40000px;" />
	        </div>  

	        <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left; justify-content: center;display: flex;">	
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit" value="Save" style="width:100px; height:30px; background-color: #1D1B38;color: #fff;border: none;border-radius: 5px;"   />
	            </form>
	        </div>
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <input type="submit" value="Cancel Crop" style="width:100px; height:30px; background-color: #FF483F;color: #ffffff;border: none;border-radius: 5px;"   />
	            </form>
	        </div>            
